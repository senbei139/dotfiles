...
return {
  keys = {
    ...
    },
    {
      key = 'd',
      mods = 'LEADER',
      action = act.SendString "lazydocker\n"
    },
    ...
    --       overrides.window_background_opacity = 0.85  -- 透過ON
    --     else
    --       overrides.window_background_opacity = 1.0   -- 透過OFF
    --     end
    ...
    { key = 'c', mods = 'LEADER', action = act.SwitchToWorkspace { spawn = { cwd = wezterm.home_dir } } },
    ...
    { key = 'H', mods = 'SHIFT|CMD', action = act.AdjustPaneSize{ 'Left', 2 } },
    { key = 'l', mods = 'LEADER', action = act.ActivatePaneDirection 'Right' },
    { key = 'L', mods = 'SHIFT|CMD', action = act.AdjustPaneSize{ 'Right', 2 } },
    { key = 'k', mods = 'LEADER', action = act.ActivatePaneDirection 'Up' },
    { key = 'K', mods = 'SHIFT|CMD', action = act.AdjustPaneSize{ 'Up', 2 } },
    { key = 'j', mods = 'LEADER', action = act.ActivatePaneDirection 'Down' },
    { key = 'J', mods = 'SHIFT|CMD', action = act.AdjustPaneSize{ 'Down', 2 } },
